...
import com.uga.gastorama.repository.search.ProductSearchRepository;
...
public class ProductResourceIntTest {
    ...
    private static final Integer UPDATED_PIECES = 2;

    private static final Instant DEFAULT_PASS_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_PASS_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
     ...
     *
     * @see com.uga.gastorama.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPieces()).isEqualTo(DEFAULT_PIECES);
        assertThat(testProduct.getPassDate()).isEqualTo(DEFAULT_PASS_DATE);
    ...
    @Test
    @Transactional
    public void checkPassDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setPassDate(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].passDate").value(hasItem(DEFAULT_PASS_DATE.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.passDate").value(DEFAULT_PASS_DATE.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPieces()).isEqualTo(UPDATED_PIECES);
        assertThat(testProduct.getPassDate()).isEqualTo(UPDATED_PASS_DATE);
